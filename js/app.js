var seccionesPagina = new fullpage('#fullpage', {
    ...
    anchors: ['inicio', 'informacion', 'educacion', 'proyectos','contacto'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
    navigationTooltips: ['inicio', 'informacion', 'educacion', 'proyectos','contacto'], // Tooltips que mostrara por cada boton.
